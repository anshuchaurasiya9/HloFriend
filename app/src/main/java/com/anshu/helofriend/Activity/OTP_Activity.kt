        ...
        override fun afterTextChanged(p0: Editable?) {
            ...
            when (view.id) {
                binding.otpEditText1.id -> {
                    if (text.length == 1) inputOTP2.requestFocus()
                }
//                R.id.otpEditText2
                binding.otpEditText2.id  -> {
                    if (text.length == 1) inputOTP3.requestFocus() else if (text.isEmpty()) inputOTP1.requestFocus()
                }
                binding.otpEditText3.id -> {
                    if (text.length == 1) inputOTP4.requestFocus() else if (text.isEmpty()) inputOTP2.requestFocus()
                }
                binding.otpEditText4.id -> {
                    if (text.length == 1) inputOTP5.requestFocus() else if (text.isEmpty()) inputOTP3.requestFocus()
                }
                binding.otpEditText5.id -> {
                    if (text.length == 1) inputOTP6.requestFocus() else if (text.isEmpty()) inputOTP4.requestFocus()
                }
                binding.otpEditText6.id -> {
                    if (text.isEmpty()) inputOTP1.requestFocus()
                }
